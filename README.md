...
detection features. A cross-domain joint loss is employed to boost training. Furthermore, a new dataset comprising triple image pairs is developed for training, evaluation, and real-world testing. Experiments demonstrate that CloudHandler achieves state-of-the-art performance, exhibiting strong effectiveness, robustness, and generalization ability in both simulated scenarios and long-term real-world satellite videos.

## Dataset Preparation
We created a synthetic dataset based on the atmospheric scattering model with authentic cirrus cloud bands and satellite video scenes to simulate the motion characteristics of both thick and thin clouds in sub-second-level satellite videos.
Please download our dataset in 
 * Baidu Netdisk [CloudHandler](TODO)
 * Zenodo: TODO
